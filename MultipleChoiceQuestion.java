...
public class MultipleChoiceQuestion {
    ...
    @Override public boolean equals(Object other) {
        return other instanceof MultipleChoiceQuestion && this.title.equals(
            ((MultipleChoiceQuestion) other).title) && this.question.equals(
            ((MultipleChoiceQuestion) other).question)
